...
public class Circle_Set_Card {
    ...
    final public static int S_CIRCLE = 1;
    final public static int M_CIRCLE = 2;
    final public static int L_CIRCLE = 3;
    ...
    private int cardCircleSize;//  = 1 for large, = 2 for medium, = 3 for small
     ...
     */
    public Circle_Set_Card(Color MyColor, int size, int fill, int numberOfShapes)
    {
       cardColor = MyColor;
       cardCircleSize = size;
       cardFill = fill;
    ...
    {   // draw border
        ...
        //********************* oval
        //********************* oval
        if (cardCircleSize == S_CIRCLE){
            if (cardFill == EMPTY){//if the fill is empty
